...
export const LAYER1_VIDEO_BASE = `export const LAYER1_VIDEO_BASE = `Professional cinematic fashion video, maximum native resolution, minimum 1365x2048, target 1536x2048+, portrait 9:16, 4K clarity, 24fps.
